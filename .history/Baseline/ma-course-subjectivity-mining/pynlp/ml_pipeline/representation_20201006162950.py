...
# Step 1: Make a matrix out of the tokenized data? the length of the emotion vector the same as with word embeddings by looking them up padding it with zeros.
