...
class Text2EmotionVec(TransformerMixin):
    """A Transformer class to fit and transform emotion vector input to data.
...
# Scenario 3: prepare emotion vectors for concatenation with other (baseline or emotion lexicon) features. 
## Look at pipeline_with_lexicon, sklearn.DictVectorizer and sklearn.FeatureUnion
